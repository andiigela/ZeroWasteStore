...
export default function BasketPage(){
    ...
    function handleAddItem(productId: number,quantity: number,name:string) {
                            ...
                            >
                                ...
                                <TableCell align="center">
                                    ...
                                    <LoadingButton loading={status.loading && status.name==='add'+item.productId}
                                                   onClick={()=>handleAddItem(item.productId,item.quantity,'add'+item.productId)} color='secondary'>
                                        <Add/>
                                    </LoadingButton>
                                </TableCell>
