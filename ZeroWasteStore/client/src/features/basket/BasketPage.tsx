...
import { Add, Delete, Link, Remove } from "@mui/icons-material";
    ...
    return (
            ...
            <Grid container>
                    <Grid item xs={6}/>
                        <Grid item xs={6}>
                    <BasketSummary />
                    <LoadingButton component={NavLink} to='/checkout' style={{ backgroundColor: 'red', color: 'white', marginLeft: '40%' }}>Checkout</LoadingButton>
                        </Grid>
                </Grid>
            </>
